...
class FacialExpressionAnalyzer {
    ...
    func analyze(videoURL: URL, progressHandler: @escaping (Double) async -> Void) async throws -> (smileFrames: Int, neutralFrames: Int) {
        ...
        let timesCount = Double(times.count)
        ...
        for time in times {
            ...
            await progressHandler(Double(1 / timesCount))
        }
